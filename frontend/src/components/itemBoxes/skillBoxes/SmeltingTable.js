  ...
  return (
    ...
    <div className='overscroll-auto overflow-auto h-96'>
      <div className='border-y border-black flex space-x-5'>
        <div className='flex flex-col items-center'>
          <div className='flex space-x-5 mt-2 ml-3'>
            <img src={require('./../../../assets/ItemThumbnail/Smithing/Bronze_Bar.png')} alt='Bronze'></img>
      ...
      <div className='border-y border-black flex space-x-5'>
        <div className='flex flex-col items-center'>
          <div className='flex space-x-5 mt-2 ml-3'>
            <img src={require('./../../../assets/ItemThumbnail/Smithing/Iron_Bar.png')} alt='Iron'></img>
            <div className='font-semibold'>
              Iron Bar
            </div>
            <img src={require('./../../../assets/ItemThumbnail/Smithing/Iron_Bar.png')} alt='Iron'></img>
      ...
      <div className='border-y border-black flex space-x-5'>
        <div className='flex flex-col items-center'>
          <div className='flex space-x-5 mt-2 ml-3'>
            <img src={require('./../../../assets/ItemThumbnail/Smithing/Steel_Bar.png')} alt='Steel'></img>
            <div className='font-semibold'>
              Steel Bar
            </div>
            <img src={require('./../../../assets/ItemThumbnail/Smithing/Steel_Bar.png')} alt='Steel'></img>
      ...
      <div className='border-y border-black flex space-x-5'>
        <div className='flex flex-col items-center'>
          <div className='flex space-x-5 mt-2 ml-3'>
            <img src={require('./../../../assets/ItemThumbnail/Smithing/Silver_Bar.png')} alt='Silver'></img>
            <div className='font-semibold'>
              Silver Bar
            </div>
            <img src={require('./../../../assets/ItemThumbnail/Smithing/Silver_Bar.png')} alt='Silver'></img>
      ...
      <div className='border-y border-black flex space-x-5'>
        <div className='flex flex-col items-center'>
          <div className='flex space-x-5 mt-2 ml-3'>
            <img src={require('./../../../assets/ItemThumbnail/Smithing/Gold_Bar.png')} alt='Gold'></img>
            <div className='font-semibold'>
              Gold Bar
            </div>
            <img src={require('./../../../assets/ItemThumbnail/Smithing/Gold_Bar.png')} alt='Gold'></img>
      ...
      <div className='border-y border-black flex space-x-5'>
        <div className='flex flex-col items-center'>
          <div className='flex space-x-5 mt-2 ml-3'>
            <img src={require('./../../../assets/ItemThumbnail/Smithing/Mithril_Bar.png')} alt='Mithril'></img>
            <div className='font-semibold'>
              Mithril Bar
            </div>
            <img src={require('./../../../assets/ItemThumbnail/Smithing/Mithril_Bar.png')} alt='Mithril'></img>
      ...
      <div className='border-y border-black flex space-x-5'>
        <div className='flex flex-col items-center'>
          <div className='flex space-x-5 mt-2 ml-3'>
            <img src={require('./../../../assets/ItemThumbnail/Smithing/Adamant_Bar.png')} alt='Adamant'></img>
            <div className='font-semibold'>
              Adamant Bar
            </div>
            <img src={require('./../../../assets/ItemThumbnail/Smithing/Adamant_Bar.png')} alt='Adamant'></img>
      ...
      <div className='border-y border-black flex space-x-5'>
        <div className='flex flex-col items-center'>
          <div className='flex space-x-5 mt-2 ml-3'>
            <img src={require('./../../../assets/ItemThumbnail/Smithing/Rune_Bar.png')} alt='Rune'></img>
            <div className='font-semibold'>
              Rune Bar
            </div>
            <img src={require('./../../../assets/ItemThumbnail/Smithing/Rune_Bar.png')} alt='Rune'></img>
      ...
      <div className='border-y border-black flex space-x-5'>
        <div className='flex flex-col items-center'>
          <div className='flex space-x-5 mt-2 ml-3'>
            <img src={require('./../../../assets/ItemThumbnail/Smithing/Dragon_Bar.png')} alt='Dragon'></img>
            <div className='font-semibold'>
              Dragon Bar
            </div>
            <img src={require('./../../../assets/ItemThumbnail/Smithing/Dragon_Bar.png')} alt='Dragon'></img>
        ...
        <div>
          <button
            className={`bg-yellow-200 h-20 w-28 font-semibold border-x-2 border-black uppercase ${active === 36 ? 'bg-indigo-500' : ''}`}
            onClick={ () => handleButtonClick(36)}
          >
            { active === 36 ? 'stop' : 'select' }
          </button>
        </div>
      </div >
      </div>
