...
const WoodcuttingTable = () => {
  ...
  /**
   * 
   *  The useState actions for the progress bars
   * 
   */
  ...
  /**
   * 
   * HandleChange functions for dynamically changing the length of the progress bar
   * 
   * @param {*} e The clicked button correlating each of it's progress bar
   */
